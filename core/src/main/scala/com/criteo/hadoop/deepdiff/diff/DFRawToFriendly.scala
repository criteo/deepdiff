...
import com.criteo.hadoop.deepdiff.type_support.example.{ExampleFactory, StructExampleFactory}
import com.criteo.hadoop.deepdiff.utils.LeftRight
import com.criteo.hadoop.deepdiff.{DatasetDiffs, DatasetsSchema, KeyExample}
