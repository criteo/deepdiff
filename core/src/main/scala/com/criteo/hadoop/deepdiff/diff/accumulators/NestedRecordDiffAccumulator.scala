...
import com.criteo.hadoop.deepdiff.diff.{K, Kx, R, Rx}
import com.criteo.hadoop.deepdiff.plan.AnyStructDiffField
import com.criteo.hadoop.deepdiff.raw_part.{CommonRawDiffsPartBuilder, KindOfDiff, LeftRightRawDiffsPart}
...
private[diff] final class NestedRecordDiffAccumulator(
  ...
  import com.criteo.hadoop.deepdiff.raw_part.KindOfDiff._
