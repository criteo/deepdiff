...
/** Field hierarchy representing what should be present in the final
  ...
  */
package com.criteo.hadoop.deepdiff.plan

import com.criteo.hadoop.deepdiff.plan.field.{FieldPath, RawField}
import com.criteo.hadoop.deepdiff.plan.key._
import com.criteo.hadoop.deepdiff.type_support.comparator.{Comparator, EqualityParams}
import com.criteo.hadoop.deepdiff.type_support.example.{ArrayExampleFactory, ExampleFactory, StructExampleFactory}
import com.criteo.hadoop.deepdiff.type_support.unsafe.BinaryEquivalence
import com.criteo.hadoop.deepdiff.utils.{Common, LeftRight, LeftRightFunctor}
...
private[deepdiff] sealed trait DiffField {
  ...
  /** Unique name within a [[com.criteo.hadoop.deepdiff.RecordDiffs]] used to identify a field.
    *
