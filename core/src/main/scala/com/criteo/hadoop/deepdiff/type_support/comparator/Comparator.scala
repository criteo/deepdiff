...
package com.criteo.hadoop.deepdiff.type_support.comparator

import java.nio.ByteBuffer
import java.util

import com.criteo.hadoop.deepdiff.diff.{K, R}
import com.criteo.hadoop.deepdiff.raw_part.{CommonRawDiffsPartBuilder, KindOfDiff}
import com.criteo.hadoop.deepdiff.type_support.unsafe.{BinaryEquivalence, UnsafeComparator}
