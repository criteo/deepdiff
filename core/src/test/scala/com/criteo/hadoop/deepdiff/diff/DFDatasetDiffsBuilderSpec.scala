...
import com.criteo.hadoop.deepdiff.plan.DiffPlanBuilder
import com.criteo.hadoop.deepdiff.{DatasetDiffs, KeyExample}
...
trait DFDatasetDiffsBuilderSpec extends AnyFlatSpec with Matchers {
  import com.criteo.hadoop.deepdiff.test_utils.SparkUtils.asSparkRow
